...
public class ListTester {
	...
	private void runTests() {
		...
		// Scenario: 44
		testEmptyList(A_itNextRemove_empty, "A_itNextRemove_empty");
		...
		// Scenario: 47
		testEmptyList(AB_itNextRemoveNextRemove_empty, "AB_itNextRemoveNextRemove_empty");
		...
		// Scenario: 45
		testSingleElementList(AB_itNextRemove_B, "AB_itNextRemove_B", LIST_B, STRING_B);
		// Scenario: 46
		testSingleElementList(AB_itNextNextRemove_A, "AB_itNextNextRemove_A", LIST_A, STRING_A);
		...
		// Scenario: 23
		testThreeElementList(AB_addC_ACB, "AB_addC_ACB", LIST_ACB, STRING_ACB);

		// 3-element to empty list
		// Scenario: 54
		testEmptyList(ABC_itNextRemoveNextRemoveNextRemove_empty, "ABC_itNextRemoveNextRemoveNextRemove_empty");

		// 3-element to 1-element
		// Scenario: 51
		testSingleElementList(ABC_itNextRemoveNextRemove_C, "ABC_itNextRemoveNextRemove_C", LIST_C, STRING_C);
		// Scenario: 52
		testSingleElementList(ABC_itNextRemoveNextNextRemove_B, "ABC_itNextRemoveNextNextRemove_B", LIST_B, STRING_B);
		// Scenario: 53
		testSingleElementList(ABC_itNextNextRemoveNextRemove_A, "ABC_itNextNextRemoveNextRemove_A", LIST_A, STRING_A);

		// 3-element to 2-element via set()
		// Scenario: 33
		...
		// Scenario: 48
		testTwoElementList(ABC_itNextRemove_BC, "ABC_itNextRemove_BC", LIST_BC, STRING_BC);
		// Scenario: 49
		testTwoElementList(ABC_itNextNextRemove_AC, "ABC_itNextNextRemove_AC", LIST_AC, STRING_AC);
		// Scenario: 50
		testTwoElementList(ABC_itNextNextNextRemove_AB, "ABC_itNextNextNextRemove_AB", LIST_AB, STRING_AB);
	 ...
	 */
	private IndexedUnsortedList<Integer> A_itNextRemove_empty() {
        IndexedUnsortedList<Integer> list = emptyList_addA_A();
    ...
    private Scenario<Integer> A_itNextRemove_empty = () -> A_itNextRemove_empty();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_itNextRemove_B() {
        IndexedUnsortedList<Integer> list = A_addToRearB_AB();
        Iterator<Integer> it = list.iterator();
        it.next();
        it.remove();
    ...
    private Scenario<Integer> AB_itNextRemove_B = () -> AB_itNextRemove_B();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_itNextNextRemove_A() {
        IndexedUnsortedList<Integer> list = A_addToRearB_AB();
        Iterator<Integer> it = list.iterator();
        it.next();
        it.next();
    ...
    private Scenario<Integer> AB_itNextNextRemove_A = () -> AB_itNextNextRemove_A();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_itNextRemoveNextRemove_empty() {
        IndexedUnsortedList<Integer> list = A_addToRearB_AB();
        Iterator<Integer> it = list.iterator();
        it.next(); it.remove();
        it.next(); it.remove();
    ...
    private Scenario<Integer> AB_itNextRemoveNextRemove_empty = () -> AB_itNextRemoveNextRemove_empty();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextRemove_BC() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next();
        it.remove();
    ...
    private Scenario<Integer> ABC_itNextRemove_BC = () -> ABC_itNextRemove_BC();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextNextRemove_AC() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next();
        it.next();
    ...
    private Scenario<Integer> ABC_itNextNextRemove_AC = () -> ABC_itNextNextRemove_AC();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextNextNextRemove_AB() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
    ...
    private Scenario<Integer> ABC_itNextNextNextRemove_AB = () -> ABC_itNextNextNextRemove_AB();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextRemoveNextRemove_C() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next(); it.remove();
        it.next(); it.remove();
    ...
    private Scenario<Integer> ABC_itNextRemoveNextRemove_C = () -> ABC_itNextRemoveNextRemove_C();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextRemoveNextNextRemove_B() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next(); it.remove();
    ...
    private Scenario<Integer> ABC_itNextRemoveNextNextRemove_B = () -> ABC_itNextRemoveNextNextRemove_B();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_itNextNextRemoveNextRemove_A() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next(); it.next(); it.remove();
        it.next(); it.remove();
    ...
    private Scenario<Integer> ABC_itNextNextRemoveNextRemove_A = () -> ABC_itNextNextRemoveNextRemove_A();
	 ...
	 *         remove()
	 */
	private IndexedUnsortedList<Integer> ABC_itNextRemoveNextRemoveNextRemove_empty() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        Iterator<Integer> it = list.iterator();
        it.next(); it.remove();
        it.next(); it.remove();
    ...
    private Scenario<Integer> ABC_itNextRemoveNextRemoveNextRemove_empty = () -> ABC_itNextRemoveNextRemoveNextRemove_empty();
